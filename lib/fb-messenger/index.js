...
exports.receivedMessage = (event)=>{
	...
	if (message.attachments) {
		...
		if (att.type === 'location') {
			sendWeatherDataByCoordinates(recipientID,att.payload.coordinates);
		}
...
exports.attachmentsHandler = (event)=>{
// code goes in here
}
exports.payloadHandler = (event)=>{
	...
	if (postbackData === "city_weather") {
		...
		messageData = {
				...
				message: {
					text: "Allow me to use your location",
					quick_replies: [
						{
...
function sendWeatherDataByCoordinates(recipientID,coordinates) {
	var apptitle = "CITY WEATHER REPORT";
