...
exports.startBot = (event)=>{
	console.log("PAYLOAD RECEIVED!",event.postback.payload);
	var senderID = event.sender.id, recipientID = event.recipient.id, timeOfMessage = event.timestamp, message = event.postback.payload, messageData;
		      ...
		      "payload": {
		        ...
		        "elements": [
		          ...
		          },
		          {
		            ...
		            "default_action": {
		              "type": "web_url",
		              "url": "https://sudoweather.herokuapp.com/view?item=100",
		              "messenger_extensions": true,
		              "webview_height_ratio": "tall",
		              "fallback_url": "https://sudoweather.herokuapp.com/"
		            }
		          },
		          {
		            ...
		            "image_url": "https://sudoweather.herokuapp.com/img/blue-t-shirt.png",
		            "subtitle": "100% Cotton, 200% Comfortable",
		            "default_action": {
		              "type": "web_url",
		              "url": "https://sudoweather.herokuapp.com/view?item=101",
		              "messenger_extensions": true,
		              "webview_height_ratio": "tall",
		              "fallback_url": "https://sudoweather.herokuapp.com/"
		            },
		            "buttons": [
		              {
		                "title": "Shop Now",
		                "type": "web_url",
		                "url": "https://sudoweather.herokuapp.com/shop?item=101",
		                "messenger_extensions": true,
		                "webview_height_ratio": "tall",
		                "fallback_url": "https://sudoweather.herokuapp.com/"
		              }
