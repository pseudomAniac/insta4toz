...
exports.receivedMessage = (event)=>{
	...
	if (messageText) {
		switch(messageText) {
			...
			case 'kerema':
			case 'lorengau':
				sendLaeWeather(senderID,messageText);
				break;
			default:
...
function sendLaeWeather(recipientID,city) {
		...
		message: {
			attachment: {
				...
				payload: {
					...
					elements: [{
						title: apptitle,
						subtitle: "For weather forecast please visit www.facebook.com/PNGWeatherReports/app/1476643879330794",
						item_url: wURL,
